...
userList.createGrid = function () {
	...
	jQuery("#user_list").jqGrid({
		...
		colNames: ['社員ID','名前','社員番号', '役職名', '拠点','事業部','内線番号','入社日'
				　,'作成日','作成者','更新日','更新者'],
		colModel: [
			{ name: 'uid', index: 'user_no', width: 80, align: "center" },
			{ name: 'name', index: 'user_title', width: 200, align: "center" },
			{ name: 'u_no', index: 'inquiry_date', width: 80, align: "center" },
			{ name: 'title', index: 'user_status', width: 100 },
			{ name: 'base_cd', index: 'base_cd', width: 100, align: "center" },
			{ name: 'division', index: 'person_id', width: 100, align: "center" },
			{ name: 'telno', index: 'quoto_no', width: 80, align: "center" },
			{ name: 'start_date', index: 'quoto_issue_date', width: 80, align: "center" },
