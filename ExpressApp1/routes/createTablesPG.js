...
exports.create = function (req, res) {
  	var sql = [
		"CREATE TABLE IF NOT EXISTS drc_sch.entry_info (" // 案件データ
			...
			+ "order_accept_check INT2," // 仮受注日チェック
			+ "acounting_period_no INT2," // 会計期No
			+ "order_type INT2," // 受託区分
			+ "contract_type INT2," // 契約区分
			...
			+ "drc_substituted_amount DECIMAL(9)," // DRC立替準備金額
			+ "prior_payment_limit DATE," // 事前入金期日
			+ "prior_payment_accept DATE," // 事前入金日
			+ "pay_planning_date_1 DATE," // 分割請求日1
			+ "pay_complete_date_1 DATE," // 分割入金日1
			+ "pay_amount_1 DECIMAL(9)," // 分割支払合計金額1 
			+ "pay_result_1 INT2," // 分割請求区分1
			+ "pay_planning_date_2 DATE," // 分割請求日2
			+ "pay_complete_date_2 DATE," // 分割入金日2
			+ "pay_amount_2 DECIMAL(9)," // 分割支払合計金額2 
			+ "pay_result_2 INT2," // 分割請求区分2
			+ "pay_planning_date_3 DATE," // 分割請求日3
			+ "pay_complete_date_3 DATE," // 分割入金日3
			+ "pay_amount_3 DECIMAL(9)," // 分割支払合計金額3
			+ "pay_result_3 INT2," // 分割請求区分3
			+ "pay_planning_date_4 DATE," // 分割請求日4
			+ "pay_complete_date_4 DATE," // 分割入金日4
			+ "pay_amount_4 DECIMAL(9)," // 分割支払合計金額4
			+ "pay_result_4 INT2," // 分割請求区分4
			+ "pay_planning_date_5 DATE," // 分割請求日5
			+ "pay_complete_date_5 DATE," // 分割入金日5
			+ "pay_amount_5 DECIMAL(9)," // 分割支払合計金額5
			+ "pay_result_5 INT2," // 分割請求区分5
		...
		"CREATE TABLE IF NOT EXISTS drc_sch.user_list (" // 社員マスタ
			...
			+ "updated_id VARCHAR(32)" // 更新者ID
			+ ", PRIMARY KEY (uid));",
		"CREATE TABLE IF NOT EXISTS drc_sch.role_master (" // 権限マスタ
			...
			+ "updated_id VARCHAR(32)" // 更新者ID
			+ ", PRIMARY KEY (rid));",
		"CREATE TABLE IF NOT EXISTS drc_sch.role_list (" // 権限設定リスト
			+ "rid VARCHAR(32) NOT NULL," 
			+ "uid VARCHAR(32)," 
			+ "memo VARCHAR(128)," 
			+ "delete_check INT2," 
