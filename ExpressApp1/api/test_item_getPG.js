...
// 試験大分類の名前とコードのリストを取得する 2016.02.08
exports.get_large_item_list = function(req, res) {
	var sql = 'SELECT '
		+ 'item_cd,'
		+ 'item_name'
		+ ' FROM drc_sch.test_large_class WHERE test_large_class.delete_check = 0 ORDER BY item_cd';
		// SQL実行
