...
// 作業項目リストの取得
var workitem_get_list_all = function (req, res) {
	var sql = 'SELECT ' 
		+ 'entry_no,' 
		+ 'work_item_id,' 
		+ 'work_title,' 
...
var workitem_get_list = function (req, res) {
	var sql = 'SELECT ' 
		...
		+ 'progress,' 
		+ 'item_type' 
		+ ' FROM drc_sch.workitem_schedule WHERE entry_no = $1 and item_type = $2 and delete_check = \'0\' ORDER BY start_date';
	return workitem_get_list_for_gantt(res, sql, [req.params.entry_no, req.params.item_type]);
};
